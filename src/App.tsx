      ...
      <div className="flex min-h-screen bg-gray-50">
        ...
        <main className="flex-1 ml-60">
          <Routes>
            ...
            <Route path="/bulk-delete" element={<div className="p-6"><h1>Bulk Delete Posts</h1></div>} />
            ...
            <Route path="/ai-posts" element={<div className="p-6"><h1>AI Text/Image Posts</h1></div>} />
            <Route path="/payout" element={<div className="p-6"><h1>Payout Transfer</h1></div>} />
          </Routes>
        </main>
      </div>
    </HashRouter>

...
export const DirectPost: React.FC = () => {
  ...
  const handlePublish = async () => {
    ...
    // await fetch('/api/post', { method: 'POST', body: JSON.stringify({ caption, postType, firstComment }) })
    setTimeout(() => {
      setPublishing(false);
      ...
      {!selectedAccount ? (
        ...
        <div className="bg-white rounded-xl border border-gray-100 p-6 shadow-sm">
          ...
          <button 
            ...
            className="w-full bg-emerald-600 hover:bg-emerald-700 disabled:bg-gray-300 text-white py-3 rounded-lg font-medium flex items-center justify-center gap-2"
          >
            {publishing ? (
              <>
